...
1. 開啟「控制台」→「網路和網際網路」→「網路和共用中心」。
    ![alt text](/assets/posts/Problem Solutions/螢幕擷取畫面 2025-04-12 220056.png)
2. 點選左邊的「變更介面卡設定」。
    ![alt text](/assets/posts/Problem Solutions/螢幕擷取畫面 2025-04-12 215603.png)
3. 對你正在連線的 Wi-Fi / Ehternet 點右鍵 → 選「內容」。
    ![alt text](/assets/posts/Problem Solutions/螢幕擷取畫面 2025-04-12 220207.png)
...
6. 輸入：
    ...
    * 備用 DNS：8.8.4.4
    ...
    ![alt text](/assets/posts/Problem Solutions/螢幕擷取畫面 2025-04-12 220258.png)