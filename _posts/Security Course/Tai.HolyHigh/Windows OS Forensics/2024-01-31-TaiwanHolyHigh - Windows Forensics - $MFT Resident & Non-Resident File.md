...
* Non-Resident Flag: `01`
* File Size: `FD 02`  →  765 bytes

### Offset 65898496(d)
Resident File
* Status: `00 00`  →  file
* \$MFT Record: `62 FB`  →  `0x3ed8800`
* Standard Info
...
* Non-Resident Flag: `00`
* File Size: `99 01`  →  409 bytes

### Offset 64329728(d)
Non-Resident File(曾經是resident file)
* Status: `01 00`  →  file
* \$MFT Record: `66 F5`  →  `0x3d59800`
* Standard Info
...
* Non-Resident Flag: `01`
* File Size: `21 01`  →  289 bytes

### Offset 65873920(d)
Non-Resident File
* Status: `00 00`  →  deleted file
* \$MFT Record: `4A FB`  →  `0x3ed2800`
* Standard Info
