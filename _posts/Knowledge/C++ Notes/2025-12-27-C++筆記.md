...
如果basedClass中，有一個function是很多derivedClass都必須要客製化，不能事先定義的話，那就要特別使用這個pure virtual function，也就是先定義framework，實作的部分交給各個derivedClass，例如課本中提到的Employee Class(Based Class)中，有<span style="background-color: yellow">earning function</span>，被很多derivedClass繼承之後，會衍生出其他的earning function，但計算的方式都不一樣
