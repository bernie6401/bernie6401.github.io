...
#### Recon
這一題也是賽後解，當初看到是shell escape的題目是有想到[VimJail](https://ctftime.org/writeup/5784)或是[PicoCTF2023 Special]({{base.url}}/PicoCTF-2023/)的思路，但是完全沒有進展，無奈之下只能放棄，但放棄之前也有一些資訊:
