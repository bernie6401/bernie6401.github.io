...
#### Recon
因為最近在玩一些cyberdefender的traffic analysis，其實這一題也和之前寫的[CyberDefender - PsExec Hunt]({{base.url}}/CyberDefender-PsExec-Hunt#Q3)蠻像的，我也沒有仔細研究這個traffic大致在幹嘛，所幸直接看ntlm的authenticated username去撈就知道了
