...
Try to find different `pdf` file that has same `MD5` hash
Such as the example provided by `corkami` - [poeMD5_A](https://raw.githubusercontent.com/corkami/collisions/master/examples/poeMD5_A.pdf) and [poeMD5_B](https://raw.githubusercontent.com/corkami/collisions/master/examples/poeMD5_B.pdf)
Note that, you must notice the file size you uploaded can not too large.

## Source code - After Exploit
:::spoiler after exploit you can get the source code & flag
```php=
 <?php
