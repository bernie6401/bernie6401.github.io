...
## Background
[What is a PPTM file?](https://fileinfo.com/extension/pptm)
<font color="FF0000">It's a zip format file</font>
...
> Macros in PowerPoint function similarly to scripts allowing you to automate repetitive tasks such as formatting a slide, adding text, or creating new slide themes. <font color="FF0000">You can create and edit macros using Visual Basic for Applications (VBA) by clicking Macros in the View tab in the ribbon.</font>

## Exploit - Binwalk + Unzip
1. Binwalk
    ```bash
    ...
    Directory                       : .
    File Size                       : 98 kB
    File Modification Date/Time     : 2023:02:17 23:47:53+08:00
    File Access Date/Time           : 2023:02:18 12:31:44+08:00
    File Inode Change Date/Time     : 2023:02:18 12:31:06+08:00
...
3. Strings
    ...
    ...
    ```
    Seems this file is not the key to get flag
    But we have another option...
    ```bash!
    $ strings ./slideMasters/hidden
    Z m x h Z z o g c G l j b 0 N U R n t E M W R f d V 9 r b j B 3 X 3 B w d H N f c l 9 6 M X A 1 f Q
    ```
    
    Seems a base64 format strings: `flag: picoCTF{D1d_u_kn0w_ppts_r_z1p5}`

## Reference
[MacroHard WeakEdge Write up](https://ctftime.org/writeup/26975)