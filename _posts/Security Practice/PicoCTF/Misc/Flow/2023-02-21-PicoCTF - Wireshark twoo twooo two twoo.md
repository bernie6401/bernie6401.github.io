...
4. <font color="FF0000">通靈</font>: Set new filter
    ...
    You'll see that the sub-domain is a sequence base64 strings. Concate them and decode it, you can fetch the flag. →
    `cGljb0NURntkbnNfM3hmMWxfZnR3X2RlYWRiZWVmfQ==` → `picoCTF{dns_3xf1l_ftw_deadbeef}`
