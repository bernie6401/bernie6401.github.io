...
## Prefetch
Windows 用來**加速程式啟動**的機制，但它同時會留下 程式執行痕跡。檔案位置在`C:\Windows\Prefetch\`，會紀錄以下info
...
## Jump List
是 Microsoft Windows 的一個功能，用來顯示**某個程式最近開啟過的檔案或常用項目**。例如右鍵點擊 Word 可能會看到：
```
Recent
 ├─ report.docx
 ├─ thesis.docx
