...
#### 抱怨環節
真的學不到什麼東西，因為雖然大會給了很多時間，但是現場的器材真本不夠，我覺得他們不太有很多這種現場 demo 的經驗，包含控場、人數以及材料數量等等，都是事前需要規劃，所以到最後我們只有利用 Pre-Heater + heat gun 去除 Amazon Echo Dot 這個 Target 的 memory 晶片，原本預設是大家把晶片去除之後要去讀取裡面的資料，包含 router ip 或是加密演算法等等，再把晶片焊回去並且要是 Target 正常運作，結果由於上述原因，現場大部分的人都在等器材，所以只能把 chip 拿下來而已，整個過程非常沒有效率
